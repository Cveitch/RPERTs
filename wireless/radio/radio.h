...
#define	RADIO_HIGH_TX_POWER			4		///< Max TX Power
#define	RADIO_MEDHIGH_TX_POWER		3		///< Max TX Power
#define	RADIO_MED_TX_POWER			2		///< Max TX Power
#define	RADIO_LOW_TX_POWER			1		///< Max TX Power
#define	RADIO_LOWEST_TX_POWER		0		///< Max TX Power
