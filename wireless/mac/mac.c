...
#include <stdbool.h>
#include "wireless/xbee/xbee.h"
#include "wireless/radio/radio.h"
#include "wireless/mac/mac.h"
#include "wireless/mac_config.h"
...
*/
bool mac_init( uint32_t MAC_ADD, void(*msg_callback)(Message* msg), void(*ack_callback)(uint8_t) ){
	...
	radio_write_16bit_address(MAC_ADD);
